...
namespace Subtask_2
{
	...
	{// У першій задачі в заданому контексті об'кти класів, що входять в Симулятор є композиційними, а не агрегаційними. для даної програми поза симулятором вони не мають змісту.
		і вони створюються симулятором.
